...
try
    ...
    initials                        = 'XX';
    duration                        = [30 40 50];                           % SD of the temporal Gaussian, ms
    ...
    tme                             = clock;
    time_sigma                      = duration/(1000/frame_rate);
    ...
    for trial=1:total_trials
        ...
        for i = 1:mv_length;
            moving_grating = round(((sin(a*x+b*y+ motion_step(i)).*circle*time_gauss(i))+background));
